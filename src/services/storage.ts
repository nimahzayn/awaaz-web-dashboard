...
export async function readJson(key: string): Promise<any> {
  ...
  if (isVercel) {
    try {
      ...
      console.error("[storage] blob read failed:", key, e);
    }
...
export async function writeJson(key: string, data: any): Promise<void> {
  ...
  if (isVercel) {
    try {
      ...
      console.error("[storage] blob write failed:", key, e);
    }
  }
}
...
export async function deleteFile(key: string): Promise<void> {
  ...
  if (isVercel) {
    try {
      ...
      console.error("[storage] blob delete failed:", key, e);
    }
  }
}
...
export async function deleteByPrefix(prefix: string): Promise<void> {
  ...
  if (isVercel) {
    try {
      ...
      console.error("[storage] blob prefix delete failed:", prefix, e);
    }
  }
}
